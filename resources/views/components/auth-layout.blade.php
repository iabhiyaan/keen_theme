		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid" id="kt_login">
				...
				<div class="d-flex flex-column flex-lg-row-auto bg-primary w-lg-600px pt-15 pt-lg-0">
					...
					<!--end::Aside Top-->
					<!--begin::Aside Bottom-->
					<div class="d-flex flex-row-fluid bgi-size-contain bgi-no-repeat bgi-position-y-bottom bgi-position-x-center min-h-350px" style="background-image: url(/assets/admin/media/svg/illustrations/login-1.svg)"></div>
					<!--end::Aside Bottom-->
				</div>
				<!--begin::Aside-->
				<!--begin::Content-->
				<div class="login-content flex-lg-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden py-20 px-10 p-lg-7 mx-auto mw-450px w-100">
					...
					<div class="d-flex flex-column-fluid flex-center py-10">
						<!--begin::Signin Form-->
						<form class="form w-100" novalidate="novalidate" id="kt_login_signin_form" data-after-login-url="/index/admin-2.html">
							<!--begin::Title-->
							...
							<div class="pb-lg-0 pb-5">
								...
								<img src="/assets/admin/media/svg/social-icons/google.svg" class="w-20px h-20px me-3" alt="" />Sign in with Google</button>
							</div>
							<!--end::Action-->
						</form>
						<!--end::Signin Form-->
